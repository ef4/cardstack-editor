...
export default Component.extend({
  ...
  actions: {
    ...
    addPhoto() {
      this.set('addingImages', true);
    },
    imagesReady(images) {
      this.set('addingImages', false);
      let payload = {
      ...
      editor.run(postEditor => {
        let card = editor.builder.createCardSection('images-card', payload);
    ...
    toggleLink() {
      ...
      if (markup) {
        this.set('linkUrl', markup.attributes.href);
